    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(default='General', on_delete=django.db.models.deletion.SET_DEFAULT, to='fixflow.departments')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('date_created', models.DateTimeField(default=datetime.datetime(2026, 3, 31, 15, 50, 4, 291661))),
                ('date_updated', models.DateTimeField(default=datetime.datetime(2026, 3, 31, 15, 50, 4, 291676))),
                ('title', models.CharField(max_length=250)),
